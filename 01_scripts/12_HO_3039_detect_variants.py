##########################################################################
############ DETECT THE VARIANTS IN THE HO MSA OF THE 3,034GP ############
##########################################################################
...
# python 01_scripts/12_HO_3039_detect_variants.py
...
### PATHS TO FILES 
alignment_file = "03_output/06_HO_sequences_3039/HOcds_filtered_with_ref.aligned.fasta"
...
# for the cds, add the effect on the CDS
table_variants_and_effect = variant_effect_cds(alignment, ref="HOgene_in_pHS2", quiet=False)

# write the table to csv
table_variants_and_effect.to_csv("03_output/06_HO_sequences_3039/HOcds_variants_and_effects_pHS2_vs_3039.csv")